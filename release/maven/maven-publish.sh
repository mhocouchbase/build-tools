...
case "${PRODUCT}" in
    ...
    *)
        ...
        echo "Supported products: couchbase-lite-android, couchbase-lite-android-ktx, couchbase-lite-android-ee, couchbase-lite-android-ee-ktx, couchbase-lite-android-vector-search, couchbase-lite-java-vector-search, couchbase-lite-java, couchbase-lite-java-ee"
        exit 1
        ;;
esac

echo "Maven publish completed successfully!"
